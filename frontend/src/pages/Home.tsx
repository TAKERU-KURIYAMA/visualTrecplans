  ...
  const features = [
    {
      icon: HeartIcon,
      title: '人体図UI',
      description: 'インタラクティブな人体図で直感的にトレーニング部位を選択・記録できます。'
    },
    {
      icon: ChartBarIcon,
      title: '進捗可視化',
      description: 'トレーニング記録とサプリメント摂取状況を分かりやすいグラフで可視化します。'
    },
    {
      icon: UserGroupIcon,
      title: 'ソーシャル機能',
      description: 'フィットネス仲間と記録を共有し、モチベーションを維持できます。'
    },
    {
      icon: GlobeAltIcon,
      title: '多言語対応',
      description: '日本語・英語・スペイン語・フランス語に対応した国際的なアプリです。'
    }
  ]
